...
import { assignStrangeInfo, calculateMaxLevel, assignMilestoneInformation, assignPuddles, toggleConfirm, toggleSwap, calculateEffects, getDischargeScale, assignBuildingInformation, assignMaxRank, calculateTrueEnergy } from './Stage';
...
export const global: globalType = { //For information that doesn't need to be saved
    ...
    collapseInfo: {
        ...
        unlockR: [0.18, 0.3, 0.8, 1.3, 40], //Researches
        newMass: 0,
        starCheck: [0, 0, 0],
        trueStars: 0
    },
    ...
    researchesExtraInfo: [
        {} as globalType['researchesExtraInfo'][0], { //Stage 1
            ...
            effectText: [
                ...
                () => { //[2]
                    const textUnlocked = player.stage.resets >= 1 || player.researchesExtra[1][2] >= 2;
    ...
    researchesAutoInfo: {
        ...
        costRange: [
            [1e13, 2e34, 1e30],
            [136000, 272000] //Second one set through updatePlayer
        ],
    ...
    elementsInfo: {
        ...
        startCost: [
            ...
            1e39, 1e41, 2e42, 3e43, 4e44, 5e45, 1e48, 1e54, 1e58
        ]
    },
    strangenessInfo: [
        {} as globalType['strangenessInfo'][0], { //Stage 1
            ...
            effectText: [
                ...
                () => `Automatically Vaporize when reached enough boost from new Clouds. (Need to be enabled in Settings)${global.strangenessInfo[2].max[4] > 1 ? `\nSecond level will allow to automatically gain ${format(2.5)}% of Clouds per second. (Doesn't disable Auto, also not affected by global speed)` : ''}`,
            ...
            cost: [],
            startCost: [1, 2, 2, 24, 12, 4, 4, 24, 9600, Infinity],
            ...
            effectText: [
                ...
                () => 'Unlock yet another new Upgrade, its even better.\n(Current unlocks: none)'
            ],
            cost: [],
            startCost: [1, 2, 4, 2, 12, 6, 6, 24, 6400, Infinity],
    ...
    lastUpgrade: [[null, 'upgrades'], [null, 'upgrades'], [null, 'upgrades'], [null, 'upgrades'], [null, 'upgrades'], [null, 'researches']],
    lastElement: null,
    lastStrangeness: [null, 0],
    lastMilestone: [null, 0],
    lastChallenge: [-1, null],
    milestonesInfo: [
        {} as globalType['milestonesInfo'][0], { //Stage 1
            ...
            rewardText: [
                ...
                () => "Vacuum instability. ('Advanced' subtab)"
            ],
            need: [new Overlimit('Infinity'), new Overlimit('Infinity')],
            time: [3600, 1200],
            scaling: [
    ...
    challengesInfo: {
        ...
        effectText: [
            () => {
                ...
                if (progress[5] >= 1) { text += '\n\n<span class="cyanText">‒ Quasi stars can\'t be created or gained</span>'; }
